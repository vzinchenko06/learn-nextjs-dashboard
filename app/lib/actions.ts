...
export async function createInvoice (prevState: InvoiceFormState, formData: FormData) {
  console.log('-> createInvoice', Object.fromEntries(formData.entries()))
...
export async function updateInvoice (id: string, prevState: InvoiceFormState, formData: FormData) {
  console.log('-> updateInvoice', id, Object.fromEntries(formData.entries()))
...
export async function deleteInvoice (id: string, formData: FormData) {
  console.log('-> deleteInvoice', id, Object.fromEntries(formData.entries()))
